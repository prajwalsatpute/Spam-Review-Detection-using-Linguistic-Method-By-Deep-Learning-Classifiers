...
<div class="form-group">
<label class="col-md-3 control-label">Choose Vaccine:</label>
    <div class="col-md-9">                                                                                                                                        
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="wdnd" value="Website Design & Development" checked="checked"/> Covishield</label><br>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="seo" value="SEO (Search Engine Optimization)" />Covin</label><br>
                                             <label class="check">
